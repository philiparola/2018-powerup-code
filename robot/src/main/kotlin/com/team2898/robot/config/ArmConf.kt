...
const val ARM_PWM_OFFSET: Int = -3720

const val CRUISE_SPEED: Double = 120.0 // Deg/s
const val MAX_ACC: Double = CRUISE_SPEED/2 // Deg/s^2

val MM_CRUISE_SPEED = (340/2.0).roundToInt() // STU
val MM_MAX_ACC = (MM_CRUISE_SPEED/2.0).roundToInt() // STU/s

const val ARM_CONT_MAX_AMPS = 5
const val ARM_PEAK_MAX_AMPS = 15
const val ARM_PEAK_MAX_AMPS_DUR_MS = 250

const val ARM_REDUCTION = (1 / 10.0) * (18.0 / 66.0) * (24.0 / 60.0) //= 0.0109090909 = 1:96.1

const val ARM_Kpp = 0.035 // Full output at 120 deg error
